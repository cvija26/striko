...
return(
  <div>
  <TableContainer  style={{  backgroundColor:'#262254', width:'80%',height:'82vh',
    margin:20,marginLeft:50, borderRadius:10 }} component={Paper}>
    <p className="title-green">{props.title}</p>
      <Table style={{width: "auto", tableLayout:"auto",margin:"auto auto"}}   aria-label="simple table" stickyHeader>
        ...
        <TableHead >
          ...
          <TableRow style={{cursor: "default", width: "10px"}}>
            ...
            <TableCell  style={styles.cell}  align="center" ><p style={{width: 150}} >REGISTARSKA OZNAKA RADARA</p></TableCell>
          ...
          {props.data.map((row) => (
           ...
           key={row.id}  >
              <TableCell  width="10%" style={styles.bodyCell} align="center" component="th" scope="row">
                <img className="status-logo" src="./img/green.svg" alt="green"/>
              </TableCell>
